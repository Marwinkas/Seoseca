...
// Headers
////////////////////////////////////////////////////////////
#include "Angle.hpp" // NOLINT(misc-header-include-cycle)
...
////////////////////////////////////////////////////////////
constexpr float Angle::asRadians() const { return m_radians; }

////////////////////////////////////////////////////////////
constexpr Angle Angle::wrapSigned() const {
  return radians(priv::positiveRemainder(m_radians + priv::pi, priv::tau) -
                 priv::pi);
}
...
////////////////////////////////////////////////////////////
constexpr Angle radians(float angle) { return Angle(angle); }
...
////////////////////////////////////////////////////////////
constexpr Angle operator-(Angle right) { return radians(-right.asRadians()); }
...
////////////////////////////////////////////////////////////
constexpr Angle operator*(float left, Angle right) { return right * left; }
